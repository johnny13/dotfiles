...
## MESSAGE PRINTING AND COLOR DISPLAYS
## ------------------ ---------  ------   ----    ---     --      -
_setColors_()
{
...
_randomString()
{
	...
	randomLong=$(openssl rand -hex $Half)
	#randomString=$(openssl rand -hex $Amount)
	randomString=$(echo $randomLong | cut -c1-$Amount)
	#echo $Half
}
...
## Linux or MacOS OS Install Helper
## ------------------ ---------  ------   ----    ---     --      -
